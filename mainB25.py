...
def update_ranking(team_a, team_b, score_a, score_b):
    ...
    for p in st.session_state.teams[team_a]:
        st.session_state.ranking[p] = st.session_state.ranking.get(p, 0) + rp_a
    for p in st.session_state.teams[team_b]:
        st.session_state.ranking[p] = st.session_state.ranking.get(p, 0) + rp_b
